...
public class WorkerController {
	...
	public boolean SearchWorkerByName(String workerName){
		ArrayList<String> arr_results;
		
		String queryReq = "GET:SELECT * FROM worker WHERE WorkerName=\""+workerName+"\";";
	...
	public void UpdateWorkerDetails(String workerID, String newDept, String newRole){
		String queryReq = "UPDATE:UPDATE worker SET Department='" + newDept +
